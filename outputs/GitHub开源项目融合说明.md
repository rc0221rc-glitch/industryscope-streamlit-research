...
8. 信息收集升级为“宽检索 + 深信号检索 + 最新动作检索”：
   ...
   - 新增专利报告书/专利地图信息源：强制搜索 WIPO/EPO/CNIPA/Google Patents 相关入口、`patent landscape/report/insight`、FTO、专利导航、专利地图、专利族、IPC/CPC、主要申请人和申请趋势；用于发现技术路线、竞争布局和空白点，具体权利要求仍需回到原始专利文本核验。
...
9. 来源筛选升级为“候选池 + 来源画像 + 信息浓度分层”：
   ...
   - 专利报告/专利地图会单独标注为高价值信息源；官方原始专利和政府/知识产权机构可作为 T0，专利报告用于识别方向与布局，不能替代权利要求原文。
   - T0/T1 优先支撑核心结论；T2 用于新闻和产业观点；T3 仅作为线索入口，不能单独支撑强结论。
   - 报告新增“信息源渠道分层复盘”，输出本次来源池质量结构和下次优先追踪的信息源。
10. 微信公众号内部新增二级分层：
   - 调研纪要、专家访谈、电话会纪要、产业链纪要、公司交流纪要、海外投行/研究机构翻译摘译、SemiAnalysis/Bernstein 等头部研究机构转述会被标注为“高价值公众号线索”。
   - 普通观点号保留为普通线索；营销号、荐股号、课程号会显著降权。
   - 高价值公众号仍然不能单独支撑强结论，必须追踪原始英文报告、公司公告、论文、专利或权威媒体交叉验证。
